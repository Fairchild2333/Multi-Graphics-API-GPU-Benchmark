...
if("WIX" IN_LIST _gpu_bench_cpack_generators)
    ...
    if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(ARM64|arm64)$" OR CMAKE_GENERATOR_PLATFORM STREQUAL "ARM64")
        # Native ARM64 and emulated x64 editions may coexist on Windows on Arm.
        set(CPACK_WIX_UPGRADE_GUID "D0B0A041-1950-4E65-895D-D14E63C09B18")
        set(CPACK_WIX_PROGRAM_MENU_FOLDER "Mangekyo ARM64")
    else()
...
if(WIN32 AND (CMAKE_SYSTEM_PROCESSOR MATCHES "^(ARM64|arm64)$" OR CMAKE_GENERATOR_PLATFORM STREQUAL "ARM64"))
    set(CPACK_PACKAGE_INSTALL_DIRECTORY "Mangekyo ARM64")
else()
