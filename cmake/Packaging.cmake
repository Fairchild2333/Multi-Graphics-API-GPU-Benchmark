...
if("WIX" IN_LIST _gpu_bench_cpack_generators)
    ...
    set(CPACK_WIX_PROGRAM_MENU_FOLDER "GPU Compute Benchmark")
endif()

set(CPACK_GENERATOR "${GPU_BENCH_CPACK_GENERATORS}")
set(CPACK_PACKAGE_NAME "GpuComputeBenchmark")
set(CPACK_PACKAGE_VENDOR "GpuComputeBenchmark contributors")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY
    "Cross-API GPU compute microbenchmark release staging payload")
